...
public class Account extends Controller {
    ...
    @SubjectPresent
    public static Result link(Long pid) {
    ...
    public static Result verifyEmail(Long pid) {
        session("currentportal", pid.toString());
    ...
    @Restrict(@Group(Application.USER_ROLE))
    public static Result doChangePassword(Long pid) {
        session("currentportal", pid.toString());
    ...
    @SubjectPresent
    public static Result askLink(Long pid) {
        session("currentportal", pid.toString());
        ...
        if (u == null) {
            ...
            return redirect(routes.Portal.publicGamesList(Application.getLocalPortal().getId()));
        }
    ...
    @SubjectPresent
    public static Result doLink(Long pid) {
        session("currentportal", pid.toString());
    ...
    @SubjectPresent
    public static Result askMerge(Long pid) {
        session("currentportal", pid.toString());
    ...
    @SubjectPresent
    public static Result doMerge(Long pid) {
        session("currentportal", pid.toString());

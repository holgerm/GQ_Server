...
System.out.println(ct.getXMLType());
		...
		if(donedialog == false){
			...
			System.out.println("Dialog Item not found");
		...
		hax.setValue(Global.SERVER_URL_2+"/assets/img/marker_blue.png");
						...
						if(act.getXMLType().equals("StartMission")){
							...
							for(AttributeType ath01: act.getAttributeTypes()){
								...
								if(ath01.getXMLType().equals("id")){
									...
									System.out.println("BAG: Found Mission Attribute in StartMission-Action. Setting Abstract Value");
			...
			System.out.println("Problem accessing NPCTalk MissionType.");

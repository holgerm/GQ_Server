...
import util.Global;
    ...
    public class ProviderPortal extends Model {
        ...
        public ProviderPortal(String startName, String url,String tf,String tpwf,
                              String tuf,String tpw, String tu, String alurl,
                              boolean av, String button,String murl,String csurl,
                              String purl,String acss, String clr, String dpr,
                              String c2,String c3,String c4,String c5,String limg){
                     ...
                     if(TemplatePw != null && !TemplatePw.equals("")){
                         ...
                         HtmlSubmitInput button = null;
                            ...
                            if(!TemplateUserField.equals("")){
                                ...
                                final HtmlTextInput textField2 = (HtmlTextInput)page.getByXPath("//input[@type='text']").get(0);
                                ...
                                if(!TemplatePw.equals("")){
                                    ...
                                    if(!TemplateFormField.equals("")){
                                        ...
                                        //XPATH - GEHE DAVON AUS DAS ES EIN PASSWORTFELD IST
                                    		...
                                    		try{
                                        final HtmlPasswordInput textField2 = (HtmlPasswordInput)page.getByXPath("//input[@type='password']").get(0);
                                  ...
                                  //  System.out.println("#### Template Formular Password Daten gefunden: /"+type+"/");
                    ...
                    while(!couples.isEmpty()){
                        ...
                        for(Couple acouple : couples){
                            ...
                            if(acouple.getZahl()<min | min < 0){
                               ...
                               //System.out.println("################ Starte Suche nach: "+currentcouple.getWort());
...
ProviderGames onepg = getGame(GameList.get(j).getGame());
      ...
      public void addGameType(GameType x){ gameTypes.add(x); }
      ...
      public boolean hasGameType(String x){
    	  ...
    	  for(GameType gt: gameTypes){
    		  ...
    		  if(gt.getName().equals(x)){ help = true; }
      ...
      public boolean hasGameType(GameType ts){
    	  ...
    	  for(GameType gt: gameTypes){
    		  ...
    		  if(gt.getId().equals(ts.getId())){ help = true; }
      ...
      public Integer getLogoHeight(Integer i){
        ...
        public static final Finder<Long, ProviderPortal> find = new Finder<Long, ProviderPortal>(
                Long.class, ProviderPortal.class);
		...
		public GameType getGameType(String x) {
		    	  ...
		    	  for(GameType gt: gameTypes){
		    		  ...
		    		  if(gt.getName().equals(x)){ return gt; }

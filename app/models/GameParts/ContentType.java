...
public class ContentType extends Model {
    ...
    public void addPossibleContentType(ContentType ct){ possibleContentTypes.addContent(ct); possibleContentTypes.update(); }
    ...
    public void addDefaultContent(Content c){ defaultContent.addContent(c); }
...
public List<ContentType> getPossibleContentTypes(){ return possibleContentTypes.getContents(); }
    
public List<Content> getDefaultContents(){ return defaultContent.getContents(); }

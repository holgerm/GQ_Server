...
public class AttributeType extends Model {
	...
	public void setShowInParent(boolean x) {
		showinparent = x;
	}
	...
	public void addPossibleValue(String x) {
		SortedString nss = new SortedString(x);
		nss.save();
		possibleValues.add(nss);
	}
	...
	public List<String> getPossibleValues() {
		...
		for (SortedString ss : possibleValues) {
			possibleValuesAsString.add(ss.getString());
		}
	...
	public String getFileType() {
		...
		if (filetype.equals("stringseconds")) {
			return "String";
		}
	...
	public static final Finder<Long, AttributeType> find = new Finder<Long, AttributeType>(Long.class,
			AttributeType.class);

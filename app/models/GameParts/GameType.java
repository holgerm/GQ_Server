...
public class GameType extends Model {
    ...
    public void addPossiblePartType(PartType pt){ possiblePartTypes.add(pt); }
    public void addPossibleHotspotType(HotspotType ht){ possibleHotspotTypes.add(ht); }
    public void addPossibleSceneType(SceneType st){ possibleSceneTypes.add(st);}
    public void addDefaultPart(Part p){ defaultParts.add(p); }
    public void addDefaultHotspot(Hotspot h){ defaultHotspots.add(h); }
    public void setOnlySceneType(SceneType st){ editor_only_scene_type = st; multiple_only_scene_type = true;}
    public void setOnlySceneTypeBool() {multiple_only_scene_type = true;}
    public void addPossibleMenuItemActionType(ActionType pt){ possibleMenuItemActionTypes.add(pt); }
...
public void setAttributeType(AttributeType t){
    ...
    public List<SceneType> getPossibleSceneTypes(){ return possibleSceneTypes;}
    public List<Part> getDefaultPart(){ return defaultParts; }
    public List<Hotspot> getDefaultHotspot(Hotspot h){ return defaultHotspots; }
    ...
    public boolean hasOnlyOneScene(){ if(multiple_only_scene_type == true){ return true; } else { return false; } }
    ...
    public Game createMe(String n){
    	...
    	g.addPart(ap.copyMe(add,missionbinder,hotspotbinder));
    		g.update();
    		
    		if(ap.isScene()){ ap.getScene().redoLinking(g); }

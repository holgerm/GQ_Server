...
public class RuleType extends Model {
    ...
    public void addPossibleActionType(ActionType at) {
        possibleActionTypes.add(at);
    }

    public boolean addPossibleCondition(Condition c) {
        boolean help = false;
        if (c.isType()) {
    ...
    public void addDefaultImplementation(Rule r) {
        defaultImplementation = r;
    }
    ...
    public List<Condition> getPossibleConditions() {
        return possibleConditions;
    }

    public Rule getDefaultImplementation() {
    ...
    public Rule createMe(GameCopyContext copyContext) {
        Rule r = defaultImplementation.copyMe(copyContext);
        r.save();
        return r;
    }

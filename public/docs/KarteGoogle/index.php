...
.btn-success {
  ...
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#5c7093", endColorstr="#354054");
  background-image: -khtml-gradient(linear, left top, left bottom, from(#5c7093), to(#354054));
  background-image: -moz-linear-gradient(top, #5c7093, #354054);
  background-image: -ms-linear-gradient(top, #5c7093, #354054);
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #5c7093), color-stop(100%, #354054));
  background-image: -webkit-linear-gradient(top, #5c7093, #354054);
  background-image: -o-linear-gradient(top, #5c7093, #354054);
  background-image: linear-gradient(#5c7093, #354054);
  border-color: #354054 #354054 hsl(218, 23%, 22%);
  color: #fff !important;
...
<base href="https://www.quest-mill.com/geoquest/<?=$url?>/index.html" />
</head>
...
<br/><br/>
 ...
 <li><a href="../index.php?content=Start">Wilkommen</a></li>

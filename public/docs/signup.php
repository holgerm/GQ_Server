...
<form action="https://quest-mill.intertech.de/61/signup" method="POST" >
...
<div class="input-group">
  ...
  <input type="text" class="form-control" placeholder="Dein Name" aria-describedby="basic-addon1"  id="name" name="name" style="border-radius:2px;" >
</div>
...
<div class="input-group" style=" width: 100%;">
  <span class="input-group-addon" id="basic-addon1" style="width:39px;">   @</span>
</span>
...
<div class="input-group" >
  ...
  <input type="password" class="form-control" placeholder="Password (mindestens 5 Zeichen)" aria-describedby="basic-addon1"  id="password" name="password" style="border-radius:2px;">
</div>
...
<div class="input-group" >
  ...
  <input type="password" class="form-control" placeholder="Password wiederholen" aria-describedby="basic-addon1"  id="repeatPassword" name="repeatPassword" style="border-radius:2px;">
</div>
...
<div class="btn-group">
  ...
  Account erstellen
            ...
            <br/>
        <br/><div style="font-size:x-small"><a href="https:/quest-mill.intertech.de/assets/login.php">Ich habe schon einen Account</a></div>
